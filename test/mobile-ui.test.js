...
test('dashboard mobile shell keeps five primary tabs and moves secondary tools into More',()=>{
  const html=read('prototype/dashboard.html'),styles=read('prototype/mobile.css'),script=read('prototype/mobile.js');
  assert.match(html,/mobile\.css\?v=20260615-mobile2/);
  assert.match(html,/mobile\.js\?v=20260615-mobile2/);
  ...
  assert.match(script,/data-mobile-view="calendar"/);
  assert.match(script,/data-mobile-view="notifications"/);
...
test('public and account pages load the phone-first layer',()=>{
  assert.match(read('prototype/index.html'),/mobile\.css\?v=20260615-mobile2/);
  assert.match(read('prototype/account.html'),/mobile\.css\?v=20260615-mobile2/);
