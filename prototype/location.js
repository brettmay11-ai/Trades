...
function syncMarketplaceLocation(){
  ...
  if(postForm&&!postForm.dataset.locationReady){postForm.elements.city.value=company.city;postForm.elements.state.value=company.state;window.TradesTaxonomy?.setLocationMetadata(postForm.elements.city,company);postForm.dataset.locationReady='true'}
